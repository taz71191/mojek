from mojek.expense_tracker import expense_tracker, update_gsheet
...
def hello():
    return """
        Hello, send me your expense using https://enigmatic-plateau-09140.herokuapp.com/expense-tracker?narration={narration}
        OR
        Upload bank statements using https://enigmatic-plateau-09140.herokuapp.com/upload-statement"""
